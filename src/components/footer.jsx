...
import shaperight from '../assets/images/footer-shape-right.png'
import shapeleft from '../assets/images/footer-shape-left.png'
const Footer = () => {
  return (
      <>
                ...
                <div className="container">
                            ...
                            <div className="w-full md:w-1/2 lg:w-3/12">
                                <div className="footer_about mt-13 mx-3">
                                    ...
                                    <div className="footer_content mt-8">
                                        <p className="text-white">Tech Company based in Ethiopia , founded with profassionals</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="footer_copyright pt-3 pb-6 border-t-2 border-solid border-white border-opacity-10 sm:flex justify-between">
                        ...
                        <div className="footer_copyright_content pt-4 text-center">
                            <p className="text-white">Designed and Developed by <a href="https://uideck.com" rel="nofollow" className="text-white hover:text-theme-color">ParfoNet</a></p>
                        </div>
                    </div>
                </div>
            </footer>
